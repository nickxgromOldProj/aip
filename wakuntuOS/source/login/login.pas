...
begin
  ...
  begin
    load_draw;
    Button2.Caption := 'Регистрация';
    Button1.Caption := 'Войти';
    Button1.Top := 330;
  end;
...
begin
  if Button2.Caption = 'Создать профиль' then
  begin
    ShowMessage('Done');
  end
  else
  begin
    ...
    Button2.Caption := 'Создать профиль';
    Button1.Caption := 'Назад';
    Button1.Top := 430;
  end;
end;
