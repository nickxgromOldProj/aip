...
begin
  Memo1.Text := 'Вычислить количество пятниц, приходящихся на 13-е числа' + #13#10 + 'а) XX столетия;' + #13#10 + 'б) столетия с номером n, где n-данное натуральное число';
  Memo1.Visible := true;
end;
