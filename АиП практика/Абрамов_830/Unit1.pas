...
begin
  ...
  begin
   ...
   case b of
    ...
    Label1.Caption := 'По современному календарю,' + #13#10 + 'веденная вами дата соответствует:' + #13#10
                      + IntToStr(a) + m + IntToStr(c) + ' года';
  end
  else
    MessageBox(0, 'Необходимо корректно заполнить все поля', 'Ошибка', mb_iconError);
end;

procedure TForm1.E1Click(Sender: TObject);
begin
  Memo1.Font.Size := 14;
  Memo1.Text := 'Даны натуральные числа a, b и c, обозначающие число месяц и год по юлианскому календарю. Получить эту дату по современному календарю';
  Memo1.Visible := true;
end;
