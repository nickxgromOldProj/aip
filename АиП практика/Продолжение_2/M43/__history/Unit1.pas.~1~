...
begin
  ...
  Label1.Caption := 'Кол-во строк с возрастающей последовательностью: ' + IntToStr(k);
end;
...
begin
  Memo1.Text := 'Дана целочисленная матрица размера M × N. Найти количество ее строк, элементы которых упорядочены по возрастанию.';
