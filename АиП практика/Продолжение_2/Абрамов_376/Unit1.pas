...
begin
  Memo1.Text := 'Даны натуральное число m, целые числа a[1], ... a[m] и целочисленная матрица порядка m. Строку с номером i матрицы назовем отмеченной, если a[i]>0, и неотмеченной в противном случае.' + #13#10 +
